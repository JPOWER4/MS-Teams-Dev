...
import GetBGetBooksMessageExtension from "../getBGetBooksMessageExtension/GetBGetBooksMessageExtension";
import { DialogSet, DialogState } from "botbuilder-dialogs";
// Initialize debug logging module
const log = debug("msteams");

/**
 * Implementation for Get BGetBooks Bot
 */
@BotDeclaration(
    "/api/messages",
    new MemoryStorage(),
...
export class GetBGetBooksBot extends TeamsActivityHandler {

    private readonly conversationState: ConversationState;
    /** Local property for GetBGetBooksMessageExtension */
    @MessageExtensionDeclaration("getBGetBooksMessageExtension")
    private _getBGetBooksMessageExtension: GetBGetBooksMessageExtension;
    ...
    public constructor(conversationState: ConversationState) {
        super();
        // Message extension GetBGetBooksMessageExtension
        this._getBGetBooksMessageExtension = new GetBGetBooksMessageExtension();
