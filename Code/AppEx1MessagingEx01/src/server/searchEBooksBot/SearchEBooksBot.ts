...
import SearchEBooksMessageExtension from "../searchEBooksMessageExtension/SearchEBooksMessageExtension";
import { DialogSet, DialogState } from "botbuilder-dialogs";
// Initialize debug logging module
const log = debug("msteams");

/**
 * Implementation for SearchEBooks Bot
 */
@BotDeclaration(
    "/api/messages",
    new MemoryStorage(),
...
export class SearchEBooksBot extends TeamsActivityHandler {

    private readonly conversationState: ConversationState;
    /** Local property for SearchEBooksMessageExtension */
    @MessageExtensionDeclaration("searchEBooksMessageExtension")
    private _searchEBooksMessageExtension: SearchEBooksMessageExtension;
    ...
    public constructor(conversationState: ConversationState) {
        super();
        // Message extension SearchEBooksMessageExtension
        this._searchEBooksMessageExtension = new SearchEBooksMessageExtension();
