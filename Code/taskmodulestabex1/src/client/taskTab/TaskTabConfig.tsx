...
/**
 * Implementation of taskTab configuration page
 */
export const TaskTabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: pages.config.SaveEvent) => {
        ...
        pages.config.setConfig({
            contentUrl: host + "/taskTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            websiteUrl: host + "/taskTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            suggestedDisplayName: "taskTab",
            removeUrl: host + "/taskTab/remove.html?theme={theme}",
