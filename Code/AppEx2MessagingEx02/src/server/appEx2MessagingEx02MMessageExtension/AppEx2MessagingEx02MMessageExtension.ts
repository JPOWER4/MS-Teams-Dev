...
@PreventIframe("/appEx2MessagingEx02MMessageExtension/config.html")
@PreventIframe("/appEx2MessagingEx02MMessageExtension/action.html")
export default class AppEx2MessagingEx02MMessageExtension implements IMessagingExtensionMiddlewareProcessor {
